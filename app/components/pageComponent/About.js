    ...
    >
      <div className="max-container padding-container z-10 flex flex-col lg:flex-col xl:flex-row gap-10 pb-14 xl:pb-32 lg:pt-16 lg:px-20  ">
        <div className="flex flex-col w-full xl:w-[50%]  gap-5 items-center ">
          <h1 className="flex  bg-[#8C52FF] p-2 rounded-2xl font-bold text-white text-3xl lg:text-4xl xl:text-5xl">
            About Me
          </h1>
          <div className={`flex bg-[#8C52FF]  p-1 rounded-2xl`}>
            <article className="flex flex-col gap-2 lg:gap-5 rounded-5xl py-5 px-5 lg:px-10 xl:pt-12 xl:pb-20 text-[12px] md:text-sm lg:text-md xl:text-md text-gray-900 indent-10 lg:indent-20 text-pretty leading-normal md:leading-7 xl:leading-8 text-justify break-words  bg-white">
