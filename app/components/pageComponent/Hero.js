    ...
    >
      <div className="relative h-full flexBetween max-container w-full padding-container flex flex-col gap-1 lg:gap-5 pt-5 pb-40 md:pb-60 lg:pb-40 md:gap-10 lg:pt-35 lg:px-5  text-white ">
        ...
        <Image
          ...
          width={500}
          height={500}
          className="absolute bottom-0 w-64 h-60 md:w-[500px] md:h-[320px] lg:left-10 lg:w-[550px] lg:h-[500px] object-cover "
        />

        <div className="flex overflow-auto grow py-5 px-10 w-full self-center lg:self-end pro:w-[450px] pro:h-[400px] pro:mr-24 pro:mb:0  pro:px-1 md:w-[600px] lg:h-64 lg:w-[900px] mt-5 md:mt-0 mb-14 lg:mb-4 lg:mr-20  bg-[#8C52FF] rounded-5xl lg:rounded-[100px] items-center">
          ...
          <div className="absolute invisible lg:visible hover:scale-125 w-20 h-16 right-12 bottom-56 md:right-40 md:bottom-72 lg:right-24 lg:bottom-52 pro:right-24 xl:right-48 xl:bottom-48">
            <ScrollDownAnimation />
          </div>
