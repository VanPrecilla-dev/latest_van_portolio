export const VAN_DETAILS = [
  {
    home: {
      introduction: "Hi, I’m Van,",
      position: "a Web Developer",
      tagline:
        "A tech enthusiast with banking background, I am excited to innovate in web and app development projects and craft engaging websites. I am ready and thrilled to make a positive impact in a dynamic team or make a solo web project.",
    }},
   { about: {
      aboutMeP1:
        "I'm a quick-learning tech enthusiast with under a year of experience as an Associate Software Engineer and over 6 years of experience in banking.",
      aboutMeP2:
        "I graduated with a Bachelor of Science in Management Technology, which is a combination of business and programming, in 2015. I career-shifted in 2023 from banking to tech. I relearned web programming languages and taught myself to be a programmer. As a career-shifter, I'm always eager to grow, with a focus on independent learning and resourcefulness. In addition to coding, I have a keen interest in UI/UX design.",
      aboutMeP3:
        "I have practice projects that I'm open to sharing. Feel free to explore my practice projects and visit my GitHub account for an overview of the projects and their source codes.",
      aboutMeP4:
        "For a bit more trivia about me: I love reading novels whenever I have free time. I'm also into photography, especially enjoying taking photos of my friends. I love watching anime and am a fan of BTS.",
    }},
    {skills: {
      frontEnt:
        "HTML5 | CSS | Bootstrap | Tailwind | jQuery | SaaS | JavaScript | Typescript | React.js, | Next.js | Angular ",
      backEnd: " Node.js | Express.js | PHP",
      database: "MySQL | SQL",
      otherSkills:
        "Basic Knowledge: C++ | C# | Java | Git | GitHub && Non-tech: Drawing | Photography | Graphic Design | Adobe Photoshop | Lightroom | Illustrator | Canva",
    }},
    {contact: {
